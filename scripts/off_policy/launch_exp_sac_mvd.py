...
launcher = Launcher(exp_name='off_policy_sac_mvd',
                    python_file='exp_sac_mvd',
...
for env, horizon, batch_size, n_epochs, n_steps, warmup_transitions, n_features_actor, n_features_critic, initial_replay_size in \
        zip(envs, horizons, batch_sizes, n_epochss, n_stepss, warmup_transitionss, n_features_actors, n_features_critics, initial_replay_sizes):
