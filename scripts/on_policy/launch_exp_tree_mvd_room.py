...
n_estimators_tree_fit_l = [25]
min_samples_split_tree_fit_l = [8]
min_samples_leaf_tree_fit_l = [4]
n_jobs_tree_fit = 1
use_replay_memory = True
max_replay_memory_size = 500000
replay_memory_samples_l = [10000, 25000]
n_epochs_policy_l = [4]
mc_grad_estimator = 'mvd'
batch_size_policy_l = [128]
...
callbacks = True
verbose = False
preprocess_states_l = ['minmax']

for env_domain, n_epochs in zip(env_domain_l, n_epochs_l):

    for horizon, gamma, n_steps_per_fit, \
        ...
        batch_size_policy, n_features_actor, lr_actor, mc_samples_gradient, n_iters_critic, n_epochs_policy in \
            zip(horizon_l, gamma_l, n_steps_per_fit_l,
