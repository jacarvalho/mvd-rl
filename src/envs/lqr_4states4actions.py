...
class LQR4states4actions(LQR):

    __name__ = 'LQR4states4actions'
...
if __name__ == '__main__':
    mdp = LQR4states4actions(horizon=500, gamma=0.99)
    compute_stable_K(mdp, 0.1, std=2.)
